part of 'trainerManagementScreen.dart';

class TrainerListView extends StatefulWidget {
  final AppUserModel model;
  final UserModel admin;
  final List<TrainerListViewState> stateList;

  TrainerListView(this.model, this.admin, this.stateList, {Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TrainerListViewState();
  }
}
///======================================================================================
class TrainerListViewState extends StateBase<TrainerListView> {
  TrainerListViewCtr controller = TrainerListViewCtr();
