...
import '/screens/trainerManagementPart/userFullInfoCtr.dart';
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    Chip(
                        label: Row(
                          ...
                          children: [
                            Visibility(
                              visible: controller.pupilModel.isExerciseTrainer,
                              child: Icon(IconList.tickM, color: Colors.white,),
                            ),
                            Text('${tInMap('trainerManagementPage', 'isExerciseTrainer')}')
                                .color(controller.pupilModel.isExerciseTrainer? Colors.white: Colors.grey),
                            SizedBox(width: 6,),
                            VerticalDivider(indent: 2, endIndent: 2, color: Colors.white,),
                            SizedBox(width: 6,),
                            Visibility(
                              visible: controller.pupilModel.isFoodTrainer,
                              child: Icon(IconList.tickM, color: Colors.white,),
                            ),
                            Text('${tInMap('trainerManagementPage', 'isFoodTrainer')}')
                                .color(controller.pupilModel.isFoodTrainer? Colors.white: Colors.grey),
                          ],
                        )
                    ),
                  ],
                ...
                Row(
                  ...
                  children: [
                    Text('${tInMap('trainerManagementPage', 'isBroadcastCourse')}'),

                    Builder(
                      builder: (context) {
                        if(!controller.pupilModel.broadcastCourse){
                          return Text('${t('no')}').boldFont();
                        }
                        ...
                        return Text('${t('yes')}')
                            ...
                            .boldFont()
                            .wrapBackground(
                          backColor: AppThemes.currentTheme.warningColor,
                          radius: 2,
                ...
                Row(
                  children: [
                    TextButton(
                        onPressed: (){
                          controller.gotoBioScreen();
                        },
                        child: Text('${tInMap('trainerManagementPage', 'biography')}')
                    ),
                  ],
                ),
